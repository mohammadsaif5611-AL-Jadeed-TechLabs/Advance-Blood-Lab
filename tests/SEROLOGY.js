export default {
  ...
  sections: [
    ...
    /* ================= WIDAL ================= */
    {
      ...
      fields: [
        ["S TYPHI 'O'", { type: "select", options: [
          "No Agglutination",
          "Agglutination seen in 1:80",
          "Agglutination seen in 1:120",
          "Agglutination seen in 1:160"
        ]}],
        ["S TYPHI 'H'", { type: "select", options: [
          "No Agglutination",
          "Agglutination seen in 1:80",
          "Agglutination seen in 1:120",
          "Agglutination seen in 1:160"
        ]}],
        ["S PARATYPHI A (H)", { type: "select", options: [
          "No Agglutination",
          "Agglutination seen in 1:80",
          "Agglutination seen in 1:120",
          "Agglutination seen in 1:160"
        ]}],
        ["S PARATYPHI B (H)", { type: "select", options: [
          "No Agglutination",
          "Agglutination seen in 1:80",
          "Agglutination seen in 1:120",
          "Agglutination seen in 1:160"
