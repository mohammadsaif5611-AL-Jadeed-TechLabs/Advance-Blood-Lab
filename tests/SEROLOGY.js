...
,
    ...
    /* ================= VDRL ================= */
    {
      ...
      fields: [
        ["VDRL / TPHA TEST", {
          type: "select",
        options: ["NEGATIVE", "POSITIVE", "REACTIVE", "NON REACTIVE", "WEAK POSITIVE"],
        }],
        ["S. ANTI STREPTOLYSIN 'O' TITRE (ASO) (QUALITATIVE)", {
          type: "select",
        options: ["NEGATIVE", "POSITIVE", "REACTIVE", "NON REACTIVE", "WEAK POSITIVE"],
        }],
        ["S. ANTINUCLEAR ANTIBODY (ANA)", {
          type: "TEXT",
        }],
      ]
    },
...
/* ================= HBsAg ================= */
{
  ...
  fields: [
    [
      ...
      {
        type: "select",
        options: ["NEGATIVE", "POSITIVE", "REACTIVE", "NON REACTIVE"],
        after: [
...
/* ================= HCV ================= */
{
  ...
  fields: [
    ...
    ["NS1 Antigen", {
      type: "select",
        options: ["NEGATIVE", "POSITIVE", "WEAKLY REACTIVE", "NON REACTIVE", "WEAKLY POSITIVE", "REACTIVE"],
    }]
  ],
